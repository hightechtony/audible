...
class  PageCell: UICollectionViewCell {
    ...
    var page: Page? {
        didSet{
           ...
           let color = UIColor(white: 0.2, alpha: 1)
            ...
            let attributedText = NSMutableAttributedString(string: page.title, attributes: [NSAttributedStringKey.font: UIFont.systemFont(ofSize: 20, weight: UIFont.Weight.medium),  kCTForegroundColorAttributeName as NSAttributedStringKey: color])
    ...
    func setupViews() {
        ...
        textView.anchorWithConstantToTop(top: nil, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, topConstant: 0, leftConstant: 16, bottomConstant: 0, rightConstant: 16)
